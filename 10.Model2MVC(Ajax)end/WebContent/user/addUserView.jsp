...
<body>
	...
	<div class="container">
		...
		<class="bg-primary text-center"><h1 align="center">회 원 가 입</h1></class>
		<br/>
		<hr/>
		<br/>
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-3">
		      <button type="button" class="btn btn-info" id="myButton">중복확인</button>
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="ssn" name="ssn" placeholder=" - 제외 13자리입력하세요">
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
		      <button type="button" class="btn btn-primary" id="myButton" >가 &nbsp;입</button>
			  <a class="btn btn-primary btn" href="#" role="button" id="myButton" >취&nbsp;소</a>
		    </div>
		  </div>
		</form>
		<!-- form Start /////////////////////////////////////-->
